...
private static int autoCadastro(String nomeProd[], double codVal[][], int indiceVazio){
	...
	if ((resp == 's')||(resp == 'S')){
		nomeProd[0] = "Produto 1"; 
		codVal[1][0] = 1; 
		codVal[2][0] = 30; 
		codVal[3][0] = 8; 
		codVal[4][0] = (codVal[2][0]-codVal[3][0]);
		codVal[5][0] = 33; 
		codVal[6][0] = 67; 
		codVal[7][0] = (codVal[6][0]-codVal[5][0]); 
		indiceVazio = (indiceVazio+1);
		
		nomeProd[1] = "Produto 2"; 
		codVal[1][1] = 2; 
		codVal[2][1] = 5; 
		codVal[3][1] = 2; 
		codVal[4][1] = (codVal[2][0]-codVal[3][0]);
		codVal[5][1] = 541; 
		codVal[6][1] = 798; 
		codVal[7][1] = (codVal[6][0]-codVal[5][0]); 
		indiceVazio = (indiceVazio+1);
		
		nomeProd[2] = "Produto 3";
		codVal[1][2] = 3; 
		codVal[2][2] = 78; 
		codVal[3][2] = 32; 
		codVal[4][2] = (codVal[2][0]-codVal[3][0]);
		codVal[5][2] = 5;  
		codVal[6][2] = 8.5;
		codVal[7][2] = (codVal[6][0]-codVal[5][0]);
		indiceVazio = (indiceVazio+1);
		
		nomeProd[3] = "Produto 4";
		codVal[1][3] = 4; 
		codVal[2][3] = 27; 
		codVal[3][3] = 12; 
		codVal[4][3] = (codVal[2][0]-codVal[3][0]);
		codVal[5][3] = 67; 
		codVal[6][3] = 96; 
		codVal[7][3] = (codVal[6][0]-codVal[5][0]); 
		indiceVazio = (indiceVazio+1);
		
		nomeProd[4] = "Produto 5"; 
		codVal[1][4] = 5; 
		codVal[2][4] = 78; 
		codVal[3][4] = 73; 
		codVal[4][4] = (codVal[2][0]-codVal[3][0]);
		codVal[5][4] = 13; 
		codVal[6][4] = 28; 
		codVal[7][4] = (codVal[6][0]-codVal[5][0]);
		indiceVazio = (indiceVazio+1);
		
		nomeProd[5] = "Produto 6"; 
		codVal[1][5] = 6; 
		codVal[2][5] = 0; 
		codVal[3][5] = 0; 
		codVal[4][5] = (codVal[2][6]-codVal[3][6]);
		codVal[5][5] = 8; 
		codVal[6][5] = 56; 
		codVal[7][5] = (codVal[6][6]-codVal[5][6]); 
		indiceVazio = (indiceVazio+1);
		
		nomeProd[6] = "Produto 7"; 
		codVal[1][6] = 10; 
		codVal[2][6] = 12; 
		codVal[3][6] = 0; 
		codVal[4][6] = (codVal[2][6]-codVal[3][6]);
		codVal[5][6] = 8; 
		codVal[6][6] = 56; 
		codVal[7][6] = (codVal[6][6]-codVal[5][6]);
		indiceVazio = (indiceVazio+1);
